...
INSERT INTO `content` (`path`, `slug`, `type`, `title`, `data`, `filter`) VALUES
    ...
    ("blogpost-4", "exempel-pa-ingress", "post", "Exempel på ingress", "Detta är en inledning till ett blogginlägg.\n<!--more-->\nDetta är brödtext som visas när man ser hela inlägget.", "nl2br");
